...
class MyHomePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    //Since Counter is a ChangeNotifier, this reference installs a listener, and rebuilds the widget
    //completely. This is the default behavior, since the 'listen'optional parameter is not set to false. 
